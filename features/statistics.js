...
module.exports = {
    ...
    update: (guild) => {
        ...
        var rolesstat = guild.channels.cache.find(channel => channel.type == "voice" && channel.name.startsWith("Roles: "))
        var boostsstat = guild.channels.cache.find(channel => channel.type == "voice" && channel.name.startsWith("Boosts: "))
