...
fs.stat("data.json", function (err, stats) {
    ...
    fs.readFile("data.json", "utf8", (err, newData) => {
        ...
        client.on('message', message => {
            var config = data.servers[message.guild.id]
